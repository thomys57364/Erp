document.addEventListener("DOMContentLoaded", () => {
  ...
  if (nombreUsuario) {
    ...
    contenedorNombre.addEventListener("click", () => {
      localStorage.setItem("paginaAnterior", "../generos/parte_hombre/shorts/short2/short2.html");
  ...
  if (btnAñadir) {
    btnAñadir.addEventListener("click", () => {
      ...
      const producto = {
        ...
        imagen: "short_2.png" // Asegúrate de que la imagen esté en la ruta correcta
      };
