document.addEventListener("DOMContentLoaded", () => {
  ...
  if (nombreUsuario) {
    ...
    contenedorNombre.addEventListener("click", () => {
      localStorage.setItem("paginaAnterior", "../generos/parte_hombre/shorts/short1/short1.html");
  ...
  if (btnAñadir) {
    btnAñadir.addEventListener("click", () => {
      ...
      const producto = {
        ...
        imagen: "short_1.png" // Asegúrate de que la imagen esté en la ruta correcta
      };
