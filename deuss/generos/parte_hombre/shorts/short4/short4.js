document.addEventListener("DOMContentLoaded", () => {
  ...
  contenedorNombre.addEventListener("click", () => {
    ...
    localStorage.setItem("paginaAnterior", "../generos/parte_hombre/shorts/short4/short4.html")
  ...
  if (btnAñadir) {
    btnAñadir.addEventListener("click", () => {
      ...
      const producto = {
        ...
        imagen: "short_4.png" // Asegúrate de que la imagen esté en la ruta correcta
      };
