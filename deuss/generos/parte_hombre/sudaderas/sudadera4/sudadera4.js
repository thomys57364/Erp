document.addEventListener("DOMContentLoaded", () => {
  ...
  contenedorNombre.addEventListener("click", () => {
    ...
    localStorage.setItem("paginaAnterior", "../generos/parte_hombre/sudaderas/sudadera4/sudadera4.html");
  ...
  if (btnAñadir) {
    btnAñadir.addEventListener("click", () => {
      ...
      const producto = {
        ...
        imagen: "sudadera4.png" // Asegúrate de que la imagen esté en la ruta correcta
      };
