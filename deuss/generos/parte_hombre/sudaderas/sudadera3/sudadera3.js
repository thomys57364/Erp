document.addEventListener("DOMContentLoaded", () => {
  ...
  contenedorNombre.addEventListener("click", () => {
    ...
    localStorage.setItem("paginaAnterior", "../generos/parte_hombre/sudaderas/sudadera3/sudadera3.html");
  ...
  if (btnAñadir) {
    btnAñadir.addEventListener("click", () => {
      ...
      const producto = {
        ...
        imagen: "sudadera3.png" // Asegúrate de que la imagen esté en la ruta correcta
      };
