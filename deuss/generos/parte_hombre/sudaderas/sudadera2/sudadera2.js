document.addEventListener("DOMContentLoaded", () => {
  ...
  contenedorNombre.addEventListener("click", () => {
    ...
    localStorage.setItem("paginaAnterior", "../generos/parte_hombre/sudaderas/sudadera2/sudadera2.html");
  ...
  if (btnAñadir) {
    btnAñadir.addEventListener("click", () => {
      ...
      const producto = {
        ...
        imagen: "sudadera2.png" // Asegúrate de que la imagen esté en la ruta correcta
      };
