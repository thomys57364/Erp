document.addEventListener("DOMContentLoaded", () => {
  ...
  if (contenedorNombre) {
    ...
    contenedorNombre.addEventListener("click", () => {
      localStorage.setItem("paginaAnterior", "../generos/parte_hombre/camisetas/camiseta2/camiseta2.html");
  ...
  if (btnAñadir) {
    btnAñadir.addEventListener("click", () => {
      ...
      const producto = {
        ...
        imagen: "camisa2.png" // Asegúrate de que la imagen esté en la ruta correcta
      };
