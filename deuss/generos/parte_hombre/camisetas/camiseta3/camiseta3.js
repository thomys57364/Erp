document.addEventListener("DOMContentLoaded", () => {
  ...
  if (nombreUsuario) {
    ...
    contenedorNombre.addEventListener("click", () => {
      localStorage.setItem("paginaAnterior", "../generos/parte_hombre/camisetas/camiseta3/camiseta3.html");
  ...
  if (btnAñadir) {
    btnAñadir.addEventListener("click", () => {
      ...
      const producto = {
        ...
        imagen: "camisa3.png" // Asegúrate de que la imagen esté en la ruta correcta
      };
